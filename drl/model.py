...
class MLP(nn.Module):
    """ Very simple multi-layer perceptron (also called FFN)
        refer: https://github.com/facebookresearch/detr/blob/29901c51d7fe8712168b8d0d64351170bc0f83e0/models/detr.py#L289
        default: input_dim -> output_dim
        param: input_dim -> [ReLu(hidden_dim)] * (num_layers - 1) -> output_dim
    """
